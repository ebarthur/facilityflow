                ...
                <div class="card-body p-4">
                    ...
                    ${currentUser && currentUser.role === 'admin' ? `
                        <div class="d-flex gap-2 mb-3">
                            <button class="btn btn-sm btn-warning flex-fill" onclick="event.stopPropagation(); editFacility(${facility.id})">
                                <i class="fas fa-edit"></i> Edit
                            </button>
                            <button class="btn btn-sm btn-danger flex-fill" onclick="event.stopPropagation(); deleteFacility(${facility.id})">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-7">
                            <h5 class="card-title mb-3 fw-bold">
                                <i class="fas fa-building" style="color: #667eea;"></i> ${booking.facility_name || 'Unknown Facility'}
                            </h5>
                            <div class="mb-2">
                                <i class="fas fa-calendar me-2 text-muted"></i>
                                <strong>Date:</strong> <span class="text-muted">${booking.date || 'N/A'}</span>
                            </div>
                            <div>
                                <i class="fas fa-clock me-2 text-muted"></i>
                                <strong>Time:</strong> <span class="text-muted">${booking.start_time || 'N/A'} - ${booking.end_time || 'N/A'}</span>
                            </div>
                        </div>
